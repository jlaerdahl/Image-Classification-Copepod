...
def measure_object_length(image_path, pixel_size, full_image_width_pixels):
    # Read the image
    ...
    # Apply dilation to potentially close small gaps in the contours
...
measure_object_length(image_path, pixel_size, full_image_width_pixels)
